...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *CellIdentifier = @"TargetAppCell";
    ...
    cell.textLabel.text = [targetAppNames objectAtIndex:indexPath.row];
